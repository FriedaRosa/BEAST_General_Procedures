...
species_data_wide <- species_data_wide %>% 
  mutate(log_R1 = log(tp2_AOO_cell1grid/tp1_AOO_cell1grid), # for tp 1-2 comparison
         log_R2 = tp2_AOO_cell1grid-tp1_AOO_cell1grid,      # for tp 1-2 comparison
         log_R1_3 = log(tp3_AOO_cell1grid/tp1_AOO_cell1grid), # for tp 1-3 comparison
         log_R2_3 = tp3_AOO_cell1grid-tp1_AOO_cell1grid,      # for tp 1-3 comparison
         log_R1_2 =log(tp3_AOO_cell1grid/tp2_AOO_cell1grid),  # for tp 2-3 comparison
         log_R2_2 = tp3_AOO_cell1grid-tp2_AOO_cell1grid,      # for tp 2-3 comparison
...
p2 <- species_data_wide %>% 
  ...
  geom_point()+
  xlab("tp1_D")+
  ylab("tp2_AOO_cell1grid - tp1_AOO_cell1grid")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
  geom_smooth(alpha = 0.5)+
  theme_classic()+
  labs(title = "Prediction of future change")
...
p4 <- species_data_wide %>% 
  ggplot(aes(y = log_R2_3, x =tp1_D_cell1grid))+
  geom_point()+
  xlab("tp1_D")+
  ylab("tp3_AOO_cell1grid - tp1_AOO_cell1grid")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
  geom_smooth(alpha = 0.5)+
  theme_classic()+
  labs(title = "Prediction of future change")
...
p1_2 <- species_data_wide %>% 
  ggplot(aes(y = log_R1, x =tp2_D_cell1grid))+
  geom_point()+
  ylab(expression("log"~ frac("tp2_AOO_cell1grid", "tp1_AOO_cell1grid")))+
  xlab("tp2_D")+
 geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
...
p2_2 <- species_data_wide %>% 
  ggplot(aes(y = log_R2, x =tp2_D_cell1grid))+
  geom_point()+
  xlab("tp2_D")+
  ylab("tp2_AOO_cell1grid - tp1_AOO_cell1grid")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
...
p3_2 <- species_data_wide %>% 
  ggplot(aes(y = log_R1_3, x =tp2_D_cell1grid))+
  geom_point()+
  ylab(expression("log"~ frac("tp3_AOO_cell1grid", "tp1_AOO_cell1grid")))+
  xlab("tp2_D")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
...
p4_2 <- species_data_wide %>% 
  ggplot(aes(y = log_R2_3, x =tp2_D_cell1grid))+
  geom_point()+
  xlab("tp2_D")+
  ylab("tp3_AOO_cell1grid - tp1_AOO_cell1grid")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
...
gridExtra::grid.arrange(p1_2,p2_2,p3_2,p4_2)
```
...
```{r}
species_data_wide %>% 
  ggplot(aes(y = log_R1_2, x =tp3_D_cell1grid))+
  geom_point()+
...
species_data_wide %>% 
  ggplot(aes(y = log_R1_2, x =tp2_D_cell1grid))+
  geom_point()+
  ylab(expression("log"~ frac("tp3_AOO_cell1grid", "tp2_AOO_cell1grid")))+
  xlab("tp2_D")+
 #geom_smooth(method = "lm", formula = y ~ x, se = T, alpha = 0.5)+
