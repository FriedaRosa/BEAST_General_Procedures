...
table(excluded_cells$dataset) # EBBA: 66, JP: 3, NY = 20
...
table(excluded_sp$dataset) # CZ: 19, EBBA = 14, JP = 32, NY = 16
...
range(filtered_df$log_R2_1) #[1] 1.228595 4.002097

filtered_df <- Change_Data %>%
  filter(log_R2_1 <= threshold)

range(filtered_df$log_R2_1) #[1] -2.935921  1.219707
