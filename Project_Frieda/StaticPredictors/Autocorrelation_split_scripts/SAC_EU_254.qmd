...
sp_list <- unique(dd1$verbatim_name)[127:254]
...
data_species$increment <- data_reduced$increment2
    ...
    morans_list_128_254 <- morans_list
    
    data_df_128_254 <- plyr::rbind.fill(data_list)

saveRDS(data_df_128_254, paste0(out_path, "rds/SAC_df_EU1_128_254.rds"))
saveRDS(morans_list_128_254, paste0(out_path, "rds/morans_list_EU1_128_254.rds"))
