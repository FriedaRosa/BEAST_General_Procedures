...
data_df2_CZ <- plyr::rbind.fill(data_list2)
saveRDS(data_df2_CZ, paste0(out_path, "rds/SAC_df_CZ.rds"))
saveRDS(morans_list2, paste0(out_path, "rds/morans_list_CZ.rds"))
