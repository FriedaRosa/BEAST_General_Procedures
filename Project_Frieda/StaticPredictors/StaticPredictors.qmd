...
# source_path_continent <- "c:/Users/wolke/OneDrive - CZU v Praze/Datasets/Processed/Atlases/Replicated/Birds_Atlas_EBBA/"
...
# data_path_continent <- paste0(source_path_continent,"Birds_Atlas_EBBA_beast_data.rds")
# grid_path_continent <-  paste0(source_path_continent,"Birds_Atlas_EBBA_grid.gpkg")
...
```{r}
model_df <- species_data_subset_merged_short %>%na.omit()
...
sp.rf <- randomForest(r2_AOO ~ ., data=train, ntree=1000, mtry=5, importance=TRUE,
                        proximity=TRUE)
