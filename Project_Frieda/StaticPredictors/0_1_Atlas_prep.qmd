...
rm(common_cells, common_sp, presence_data2_temp, presence_data2)
...
atlas_df %>% filter(exclude == 1) %>% group_by(tp) %>% summarise(n = sum(exclude))# 45 rows have to be excluded because of saturated scales
