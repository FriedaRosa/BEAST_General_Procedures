...
sp_list <- unique(dd1$verbatim_name)[1:127]
...
data_species$increment <- data_reduced$increment2
    ...
    morans_list_1_127 <- morans_list
    
    data_df_1_127 <- plyr::rbind.fill(data_list)

saveRDS(data_df_1_127, paste0(out_path, "rds/SAC_df_EU1_1_127.rds"))
saveRDS(morans_list_1_127, paste0(out_path, "rds/morans_list_EU1_1_127.rds"))
