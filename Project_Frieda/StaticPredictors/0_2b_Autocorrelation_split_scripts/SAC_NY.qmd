...
time_periods <- c(1,2)
atlas_names <- c("Birds_Atlas_New_York")
...
data_df2_NY <- plyr::rbind.fill(data_list2)
saveRDS(data_df2_NY, paste0(out_path, "rds/SAC_df_NY.rds"))
saveRDS(morans_list2, paste0(out_path, "rds/morans_list_NY.rds"))
