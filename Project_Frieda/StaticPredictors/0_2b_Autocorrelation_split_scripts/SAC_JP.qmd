...
time_periods <- c(1,2)
atlas_names <- c("Birds_Atlas_Japan")
...
data_df2_JP <- plyr::rbind.fill(data_list2)
saveRDS(data_df2_JP, paste0(out_path, "rds/SAC_df_JP.rds"))
saveRDS(morans_list2, paste0(out_path, "rds/morans_list_JP.rds"))
