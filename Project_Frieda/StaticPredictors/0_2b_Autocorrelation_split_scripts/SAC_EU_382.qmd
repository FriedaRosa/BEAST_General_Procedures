...
sp_list <- unique(dd1$verbatim_name)[255:382]
...
data_species$increment <- data_reduced$increment2
    ...
    morans_list_255_382 <- morans_list
    
    data_df_255_382 <- plyr::rbind.fill(data_list)

saveRDS(data_df_255_382, paste0(out_path, "rds/SAC_df_EU1_255_382.rds"))
saveRDS(morans_list_255_382, paste0(out_path, "rds/morans_list_EU1_255_382.rds"))
