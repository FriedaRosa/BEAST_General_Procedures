...
sp_list <- unique(dd1$verbatim_name)[383:511]
...
data_species$increment <- data_reduced$increment2
    ...
    morans_list_383_511 <- morans_list
    
    data_df_383_511 <- plyr::rbind.fill(data_list)

saveRDS(data_df_383_511, paste0(out_path, "rds/SAC_df_EU1_383_511.rds"))
saveRDS(morans_list_383_511, paste0(out_path, "rds/morans_list_EU1_383_511.rds"))
