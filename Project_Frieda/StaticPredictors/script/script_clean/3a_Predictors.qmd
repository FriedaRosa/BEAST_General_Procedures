...
saveRDS(presence_data_all, "presence_data_all.rds")
saveRDS(presence_sf_list, "presence_sf_list.rds")
...
```{r}
sp_cell_dat <- readRDS("SpeciesDatPerCell.rds")
unique(sp_cell_dat$verbatim_name) %>% write.csv("out/SpeciesNamesData.csv")
...
saveRDS(GammaAlphaBeta_Species, "GammaAlphaBeta_Species.rds")
pred_list[[1]] <- GammaAlphaBeta_Species
rm(GammaAlphaBeta_Atlas, GammaAlphaBeta_Species)
```
...
pred_list[[2]] <- Co_Occ_df_final
saveRDS(Co_Occ_df_final, paste0(out_path, "rds/Coocc_df_final.rds"))
saveRDS(Co_Occ_df_final, "Co_Occ_df_final.rds")

rm(Co_Occ_df_final, co_occ_list2, comm_dat, comm_matrix_tp1, comm_matrix_tp2, species_data, species_data_a, species_data_a1, species_data_a1_2, a, co_occ_list1, co_occurrence_tp1, co_occurrence_tp2)

```


```{r}
save.image("3a_Predictors.RData")
saveRDS(pred_list, "pred_list.rds")
```