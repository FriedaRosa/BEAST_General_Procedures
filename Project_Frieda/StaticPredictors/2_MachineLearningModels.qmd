...
m0_f <- randomForest(log_R2_1 ~ ., data=df_red1, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H1
m1_f <- randomForest(log_R2_1 ~ ., data=H1_Geometry_df1, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H2
m2_f <- randomForest(log_R2_1 ~ ., data=H2_Traits_df1, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H3
m3_f <- randomForest(log_R2_1 ~ ., data=H3_Diversity_df1, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
...
m0_p <- randomForest(log_R2_1 ~ ., data=df_red2, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H1
m1_p <- randomForest(log_R2_1 ~ ., data=H1_Geometry_df2, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H2
m2_p <- randomForest(log_R2_1 ~ ., data=H2_Traits_df2, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 
# H3
m3_p <- randomForest(log_R2_1 ~ ., data=H3_Diversity_df2, ntree=50000, mtry=5, importance=TRUE, proximity=TRUE, na.action = na.omit) 

m0_p;m1_p;m2_p;m3_p

rf <- list(m0_f, m1_f, m2_f, m3_f, m0_p, m1_p, m2_p, m3_p)
saveRDS(rf, paste0(out_path, "rf_models_f_p.rds"))
```
